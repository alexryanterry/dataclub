...
Nearly all platforms you can get your hand on has a shell in one form or another, and many of them have several shells for you to choose from. While they may vary in the details, at their core they are all roughly the same: they allow you to run programs, give them input, and inspect
...
1.  Check out and try to install [autosuggestions for mac](https://github.com/zsh-users/zsh-autosuggestions/blob/master/INSTALL.md) or [autosuggestions for WSL/Ubuntu](https://github.com/akinomyoga/ble.sh). Note that this will require some knowledge or research of how to install packages on Linux or macOS.
